...
* Public procedures shall document:
  ...
  1. Purpose and functional specification (what it does)
  2. Mathematical or logical definition (if applicable)
  3. Assumptions or constraints
  4. Valid ranges, side effects, and failure behavior
  5. Numerical guarantees and computational complexity **only if relevant** (e.g., numerical solvers)
...
* Documentation must follow this order:
  ...
  1. Functional or mathematical definition
  2. Assumptions or constraints
  3. Valid ranges and side effects
  4. Numerical guarantees and computational complexity **if applicable**
  5. Failure behavior
...
* Include:
  ...
  * Meaning (mathematical or logical)
  * Shape, size, or type constraints
  * Overwrite behavior
  * Valid range (for scalars)
  * Requirements (e.g., must be sorted, nonnegative, etc.)
...
* If no theoretical bound exists or not relevant, write: "No theoretical error bound applicable."

### 9. Computational Complexity Rule

* State computational complexity (memory and arithmetic) **only for numerical or algorithmic procedures** where relevant.
...
* Include:
  ...
  * Algorithm overview or logical approach
  * Numerical considerations **if relevant**
  * Parallelization strategy
  * Memory usage / work arrays

### 11. Variables

* **Submodule variables:** Document only those with functional or mathematical meaning.
