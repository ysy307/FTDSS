...
contains
    ...
    module function construct_triangle_second(input) result(element)
        ...
        character(len=32), parameter :: cell_name = "QUADRATIC_TRIANGLE"
    ...
    !----------------------------------------------------------------------
    pure module function jacobian_triangle_second(self, r, node_coords) result(jac)
        implicit none
        class(type_triangle_second), intent(in) :: self
        type(type_dp_vector_3d), intent(in) :: r
        real(real64), intent(in) :: node_coords(:, :)
    ...
    !----------------------------------------------------------------------
    pure module function jacobian_det_triangle_second(self, r, node_coords) result(det_j)
        implicit none
        class(type_triangle_second), intent(in) :: self
        type(type_dp_vector_3d), intent(in) :: r
        real(real64), intent(in) :: node_coords(:, :)
