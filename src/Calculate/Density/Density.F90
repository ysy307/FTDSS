module Calculate_Density
    ...
    contains
        procedure(Abstract_Calculate_Density), pass(self), deferred :: Calculate
    ...
    contains
        procedure :: Calculate => Calc_DEN_3Phase_Wrap
        procedure :: Update => Update_DEN_3Phase
    end type Type_Density_3Phase

    abstract interface
        function Abstract_Calculate_Density(self, NodeBelonging, phi1, phi2, phi3, phi4) result(Denstiy)
        ...
        end function Abstract_Calculate_Density
    ...
    interface
        ...
        module function Calc_DEN_3Phase_Wrap(self, NodeBelonging, phi1, phi2, phi3, phi4) result(Denstiy)
            implicit none
    ...
    interface Type_Density_3Phase
        module procedure :: DEN_3Phase_Construct
    end interface
