...
contains
    ...
    logical function has_nan_real64_scalar(scalar)
        implicit none
        real(real64), intent(in) :: scalar

        has_nan_real64_scalar = ieee_is_nan(scalar)
    end function has_nan_real64_scalar

    logical function has_nan_real64_rank1(array)
        implicit none
    ...
    logical function has_nan_real64_rank2(array)
        implicit none
        real(real64), intent(in) :: array(:, :)
