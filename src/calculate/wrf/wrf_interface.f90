module calculate_wrf
    ...
    abstract interface
        pure function abst_calc_wrf(self, h) result(theta_w)
        ...
        pure function abst_calc_wrf_derivative(self, h) result(dqw_dh)
            import :: abst_wrf, real64
            implicit none
            class(abst_wrf), intent(in) :: self
            real(real64), intent(in) :: h
    ...
    interface
        ...
        module pure function calculate_wrf_mvg_derivative(self, h) result(dqw_dh)
            implicit none
            class(type_wrf_mvg), intent(in) :: self
            real(real64), intent(in) :: h
            real(real64) :: dqw_dh
    ...
    interface
        ...
        module pure function calculate_wrf_durner(self, h) result(theta_w)
            implicit none
        ...
        module pure function calculate_wrf_durner_derivative(self, h) result(dqw_dh)
            implicit none
            class(type_wrf_durner), intent(in) :: self
            real(real64), intent(in) :: h
            real(real64) :: dqw_dh
    ...
    interface
        ...
        module pure function calculate_wrf_dvgch(self, h) result(theta_w)
            implicit none
        ...
        module pure function calculate_wrf_dvgch_derivative(self, h) result(dqw_dh)
            implicit none
            class(type_wrf_dvgch), intent(in) :: self
            real(real64), intent(in) :: h
            real(real64) :: dqw_dh
