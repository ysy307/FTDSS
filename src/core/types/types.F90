module core_types
    ...
    use :: core_types_math_gauss, only:type_gauss_integration_rule
    use :: core_types_physics_state, only:type_state
    use :: core_types_physics_info, only:type_physics_info
