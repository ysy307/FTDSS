...
!>
module core_types_geometry_coordinate_array
    use, intrinsic :: iso_fortran_env, only: real64, int32
    use :: core_memory
    use :: core_types_geometry_coordinate, only:type_coordinate_dp, type_coordinate_int
    implicit none
    private
...
end module core_types_geometry_coordinate_array
