!> BiCRSTAB (stabilized BiCR) solver for nonsymmetric systems.
!> CR analogue of BiCGSTAB.
submodule(numerical_solver_interface) impl_solve_type_solver_bicrstab
...
end submodule impl_solve_type_solver_bicrstab
