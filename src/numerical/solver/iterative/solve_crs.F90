!> CRS (Conjugate Residual Squared) solver.
!> CR analogue of CGS. Transpose-free variant of BiCR.
submodule(numerical_solver_interface) impl_solve_type_solver_crs
...
end submodule impl_solve_type_solver_crs
